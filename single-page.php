...
<div id="page-profile-info">
    ...
    <br />
    <a href="single-page-likes.php" class="page-profile-likes-tag"><i class="far fa-star"></i>&nbsp;<?= $totalAppreciate['total']; ?> Appreciate</a>
    <p class="page-profile-tag"><i class="fas fa-tag"></i>&nbsp;<?= $category['category_name']; ?></p>
    <a href="#!" type="button" class="btn btn-danger text-center page-appreciate-btn page-profile-appreciate-btn mt-1" data-bs-toggle="tooltip" data-bs-placement="top"><i class="<?= !empty($isAppreciate) ? 'fa' : 'far'; ?> fa-star"></i>&nbsp;&nbsp;Appreciate</a>
    <br />
