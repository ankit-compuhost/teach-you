				...
				<div class="row mobile-page-row-view" data-aos="fade-left" data-aos-duration="700" data-aos-easing="ease-in-sine" data-aos-offset="400">
					...
					<div class="col-lg-3 page-card mb-4">
						...
						<a href="single-group.php" class="page-card-header">
							<img class="page-card-img mb-4" src="<?php echo $listings->group_picture;?>" alt="page-img">
							<br />
							<span class="page-card-title"><?php echo $listings->group_name;?></span>
							<span class="page-card-title"><?php echo $listings->$grtitle;?></span>
						</a>
						<br />
						<div>
      		...
      		<div class="modal-body">
                ...
                <div class="mb-3">
					...
					<div class="mb-3">
						...
						<select id="page-cat1" class="form-select" aria-label="Default select example">
