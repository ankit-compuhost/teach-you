	...
	<div class="container-fluid">
		<div class="row"><div class="mt-3 mb-3"></div> 
      	...
      	<div class="card page-main-content" style="border: none">
			<ul class="nav">
  				...
  				<li class="nav-item">
    				<a class="nav-link active-tab nav-link-tab" href="appreciate-pages.php">Appreciate Pages</a>
  				</li>
  				<li class="nav-item">
        ...
        <div class="col-lg-3 page-card mb-4" data-aos="zoom-in" data-aos-duration="700">
						<a href="single-page.php" class="page-card-header">
							<img class="page-card-img" src="images/page-sample-img.png" alt="page-img">
							<br />
							<span class="page-card-title">Amiraj Optometric Centre</span>
						</a>
						<br />
						<a href="single-page-likes.php" class="page-card-likes">8 Appreciate</a>
						<div>
					...
					<div class="col-lg-3 page-card mb-4" data-aos="zoom-in" data-aos-duration="700">
						<a href="single-page.php" class="page-card-header">
							<img class="page-card-img" src="images/page-sample-img.png" alt="page-img">
							<br />
							<span class="page-card-title">Learn Art & Craft</span>
						</a>
						<br />
						<a href="single-page-likes.php" class="page-card-likes">2 Appreciate</a>
						<div>
							<a href="#!" type="button" class="btn btn-danger text-center page-appreciate-btn mt-2" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fas fa-star"></i>&nbsp;&nbsp;Appreciate</a>
						</div>
					</div>
					<div class="col-lg-3 page-card mb-4" data-aos="zoom-in" data-aos-duration="700">
						<a href="single-page.php" class="page-card-header">
							<img class="page-card-img" src="images/page-sample-img.png" alt="page-img">
							<br />
							<span class="page-card-title">Web Development Basic</span>
						</a>
						<br />
						<a href="single-page-likes.php" class="page-card-likes">4 Appreciate</a>
						<div>
							<a href="#!" type="button" class="btn btn-danger text-center page-appreciate-btn mt-2" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fas fa-star"></i>&nbsp;&nbsp;Appreciate</a>
						</div>
					</div>
