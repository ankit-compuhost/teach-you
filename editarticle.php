                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-10"><input type="text" class="form-control" name="title"
                                                       placeholder="Enter Name" id=""
                                                       value="<?= !empty($error) ? $_POST['title'] : $article['title']; ?>">
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <textarea id="mytextarea"
                                      name="text"><?= !empty($error) ? $_POST['text'] : $article['text']; ?></textarea>
                            </div>
                        </div>
                        <br>
                                            ...
                                            <div class="form-input">
                                                <label for="file-ip-1">
                                                    <img id="file-ip-1-preview"
                                                         src="<?= base_url('images/camera1.png'); ?>">
                                                    <button type="button" class="imgRemove"
                                                            onclick="myImgRemove(1)"></button>
                                                </label>
                                                <input type="file" name="cover" name="img_one" id="file-ip-1"
                                                       accept="image/*"
                                                       onchange="showPreview(event, 1);">
                                            </div>
                                            <a target="_blank" href="<?= base_url($article['cover']); ?>">View Uploaded
                                                Image</a>
                                ...
                                <div class="form-select">
                                    <select class="form-control" name="category_id">
                                        ...
                                        foreach ($blogCategories as $val) {
                                            ?>
                                            <option <?= !empty($error) ? ($_POST['category_id'] == $val['category_id'] ? 'selected="selected"' : "") : ($article['category_id'] == $val['category_id'] ? 'selected="selected"' : ""); ?>
...
<script src="https://cdn.tiny.cloud/1/cxkb6y273f3s5foa38c184rw8lcxc8wldzt7i5w8bgw6ewg8/tinymce/5/tinymce.min.js"
        referrerpolicy="origin"></script>
