...
{
    global $conn;
    $page_query = "SELECT em.id, em.user_id, em.is_going, em.is_interested, e.* FROM `events` as e INNER JOIN events_members as em ON e.`event_id`=em.event_id WHERE em.user_id=$userId AND em.`is_interested`='1' GROUP BY e.event_id ORDER BY e.event_id DESC";
