 ...
 * @return array|false|string[]|null
 */
function getPageTotal(int $pageId = 0)
{
    global $conn;
    $page_query = "SELECT count(id) as total FROM pages_likes WHERE page_id='" . mysqli_real_escape_string($conn, $pageId) . "' AND (user_id !='' OR user_id !=0)";
