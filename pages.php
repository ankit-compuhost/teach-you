                    ...
                    <div class="row mobile-page-row-view">
                        ...
                        if (!empty($allPages)) {
                            foreach ($allPages as $row) {
                                $page = getPgeById($row['page_id']);
                                if ($page['page_admin'] == $_SESSION['user_id']) {
                                    continue;
                                }
                                ...
                                <div class="col-lg-3 page-card mb-4" data-aos="zoom-in" data-aos-duration="700">
                                    <a href="single-page.php" class="page-card-header">
                                        <img class="page-card-img" src="<?= $row['page_picture'] ?>"
                                             alt="<?= $row['page_title'] ?>">
                                        <br/>
                                    ...
                                    <a href="single-page-likes.php"
                                       class="page-card-likes"><?= !empty($appreciate) ? $appreciate['total'] : '0'; ?> Appreciate</a>
                                    <div>
                                        <a href="#!" type="button"
                                           class="btn btn-danger text-center page-appreciate-btn mt-2"
                                           data-bs-toggle="tooltip" data-bs-placement="top"><i class="far fa-star"></i>&nbsp;&nbsp;Appreciate</a>
                                    </div>
                                </div>
                                <?php
                            }
