    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <div class="card page-main-content article-card " style="border:none;">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link active-tab  nav-link-tab" href="article.php">Articles</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-tab" href="myarticles.php">My Articles</a>
                    </li>
                </ul>
                <div>
                                        ...
                                        <div class="card-body ">
                                            <div class="dropdown dropstart ">
                                                ...
                                                <ul class="dropdown-menu drop-font"
                                                    ...
                                                    <li><a class="dropdown-item" href="#"><i
                                                                    class="fas fa-comment-slash"></i>&nbsp;Turn Off Say
                                                            Something</a></li>
                                            ...
                                            <div class="text-center">
                                                <img src="<?= checkProfilePic(!empty($user['user_picture']) ? $user['user_picture'] : null); ?>"
                                                     alt="Avatar" class="article-card-image"
                                                     style="border-radius: 50%; width:20%; height:20%;">
                                                <br>
                                                <p style="font-size: 15px;"><strong><a href="#" style="text-decoration: none; color:black;"> <?= !empty($user['user_firstname']) ? $user['user_firstname'] . ' ' . $user['user_lastname'] : ""; ?> </a></strong>
                                                    - added a new article <i class="fas fa-globe text-muted"></i></p>
                                                <img src="<?= $val['cover']; ?>" alt="Avatar"
                                                     style=" width:90%; height:9rem;">
                                                <br><br>
                                                <p style="font-size: 12px;"><b>
                                                        <?php $title = strip_tags($val['title']);
                                                        $short_title = substr($title, 0, 50);
                                                        ?>
                                                        <a href="article/<?= $val['slug'] . ".php"; ?>"><?= $short_title; ?></a>
                                                    </b><br>
                                                    <?php
                                            ...
                                            <button type="button" class="btn  btn-star"><i
                                                        class="far fa-star"> <?= !empty($post['likes']) ? $post['likes'] : 0; ?></i>
                                            </button>
                                            <button type="button" class="btn  btn-star"><i
                                                        class="far fa-comment"> <?= !empty($post['comments']) ? $post['comments'] : 0; ?></i>
                                            </button>
                                            <button type="button" class="btn  btn-star"><i
                                                        class="far fa-share-square"> <?= !empty($post['shares']) ? $post['shares'] : 0; ?></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
