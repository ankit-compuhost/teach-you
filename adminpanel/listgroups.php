...
<div class="mt-5 mb-2"><strong><i class="fas fa-users"></i>&nbsp;&nbsp;Groups > List</strong></div> 
<br>    
            </div>
    ...
    <br>
      ...
      <table border="1" class="table table-bordered table-striped table-hover supTable list" id="Tabla">
                <tr> 
                    ...
                    <th onclick="sortTable('supTable', 1)">Group &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    ...
                    <th onclick="sortTable('supTable', 4)">Members &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
...
if($row)
{
  ...
  {
    $admin_id = $row['group_admin'];
    $query1 = "select * from users where user_id in (select group_admin from groups where group_admin = $admin_id)";
...
<td><a href="#" style="text-decoration: none; color:black;"><img src="<?php echo $row['group_picture']; ?>" class="user-profile-photo">&nbsp;</a><?php echo $row['group_title']; ?></td>
<td><a href="#" style="text-decoration: none; color:black;"><img src="<?php echo $pic; ?>" class="user-profile-photo">&nbsp;<?php echo $name.' '.$lname; ?></a></td>
<td><i class="fas fa-globe"></i>&nbsp;<?php echo $row['group_privacy']; ?></td>
