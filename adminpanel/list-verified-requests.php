...
<div class="my-2"><strong><i class="fas fa-check-circle"></i>&nbsp;&nbsp;Verification&nbsp;<i class="fas fa-angle-right" style="font-size: 11px"></i>&nbsp;Requests</strong></div>
<br>    
    ...
    <br>
      ...
      <table border="1" class="table table-bordered table-striped table-hover supTable list" id="Tabla">
                <tr> 
                    ...
                    <th onclick="sortTable('supTable', 1)">User/Page &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    <th onclick="sortTable('supTable', 2)">Type &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    <th onclick="sortTable('supTable', 3)">Time &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    <th onclick="sortTable('supTable', 4)">Actions &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    
                </tr>
                <tr>
                    <td>1</td>
                    <td><a href="#!" class="general-info-t-link">Tutor</a></td>
                    <td>Friend</td>
                    <td>2021-03-03</td>
