...
<html lang="en">
  <head>
    ...
    <title>Admin > Verification > Verified Pages</title>
...
<div class="my-2"><strong><i class="fas fa-check-circle"></i>&nbsp;&nbsp;Verification&nbsp;<i class="fas fa-angle-right" style="font-size: 11px"></i>&nbsp;Verified Pages</strong></div>
<br>    
    ...
    <br>
      ...
      <table border="1" class="table table-bordered table-striped table-hover supTable list" id="Tabla">
                <tr> 
                    ...
                    <th onclick="sortTable('supTable', 1)">Pages &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    <th onclick="sortTable('supTable', 2)">Likes &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    <th onclick="sortTable('supTable', 3)">Actions &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    
                </tr>
                <tr>
                    <td>1</td>
                    <td><a href="#!" class="general-info-t-link">Marvel Memes</a></td>
                    <td>42</td>
                    <td> <a href="userdetails.php" type="button" class="btn btn-danger rounded-circle text-center round-buttons list-v-pages-round-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Actions"><i class="fas fa-pencil-alt"></i>&nbsp;
            </a>&nbsp;&nbsp;<a type="button" class="btn btn-danger rounded-circle round-buttons list-v-pages-round-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="fas fa-trash-alt"></i>&nbsp;</a></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td><a href="#!" class="general-info-t-link">Marvel Memes</a></td>
