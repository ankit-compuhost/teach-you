...
<div class="my-2"><strong><i class="fas fa-user-times"></i>&nbsp;&nbsp;Banned IPs</strong></div>
<div><a href="#!" type="button" class="btn btn-danger text-center add-cat-btn add-ip-btn" data-bs-toggle="tooltip" data-bs-placement="top">Add New IP</a></div> 
<br>    
    ...
    <br>
      ...
      <table border="1" class="table table-bordered table-striped table-hover supTable list" id="Tabla">
                <tr> 
                    ...
                    <th onclick="sortTable('supTable', 1)">IP Address &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                    <th onclick="sortTable('supTable', 2)">Time &nbsp;&nbsp;<div class="fas fa-arrow-up rotate "></div></th>
                ...
                <tr>
                    ...
                    <td>123.456.789</td>
                    <td>2021-03-04</td>
                    <td> <a href="userdetails.php" type="button" class="btn btn-danger rounded-circle text-center round-buttons banned-ip-round-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Actions"><i class="fas fa-pencil-alt"></i>&nbsp;
            </a>&nbsp;&nbsp;<a type="button" class="btn btn-danger rounded-circle round-buttons banned-ip-round-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="fas fa-trash-alt"></i>&nbsp;</a></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>123.456.789</td>
