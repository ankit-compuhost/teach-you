...
<h2 class="my-2">The Topics Section</h2>
    <div class="row">
    <div class="col-6"><a href="admincp.php" class="btn btn-danger rounded-2 quotes"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;Go Back</a></div>
    <div class="col-6 text-center"><a class="btn btn-primary rounded-2 quotes" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New Topic</a></div>
    </div>
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel">Topic Of The Day</h5>
  ...
  <input class="form-control form-control-sm" id="formFileSm" type="file">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-modal">Add Topic</button>
      </div>
    </div>
  </div>
</div>
