...
<div id="page-profile-likes-section">
    <div class="page-profile-like-card-1">
        <a href="#!" class="page-profile-likes-user-link">
            <img class="page-profile-likes-user-img" src="images/page-sample-img.png" alt="user-profile-img">
            <p class="page-profile-likes-user">Yash Mathur</p>
        </a>
        <a href="#!" type="button" class="btn btn-danger text-center page-appreciate-btn" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fas fa-user-plus"></i>&nbsp;&nbsp;Add Friend</a>
    </div>
    <div class="page-profile-like-card-1">
        <a href="#!" class="page-profile-likes-user-link">
            <img class="page-profile-likes-user-img" src="images/page-sample-img.png" alt="user-profile-img">
    ...
    <div class="page-profile-like-card-1">
        ...
        <a href="#!" type="button" class="btn btn-danger text-center page-appreciate-btn" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fas fa-check"></i>&nbsp;&nbsp;Friends</a>
    </div>
    <div class="page-profile-like-card-1">
        <a href="#!" class="page-profile-likes-user-link">
            <img class="page-profile-likes-user-img" src="images/page-sample-img.png" alt="user-profile-img">
