        ...
        <div class="container-fluid">
            ...
            <div class="card page-main-content" style="border: none">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active-tab nav-link-tab" href="my-groups.php">My Groups</a>
                    </li>
                </ul>
                <div>
                ...
                <div class="container">
                    <div class="row mobile-page-row-view" data-aos="fade-left" data-aos-duration="700"
                        ...
                        if (!empty($allGroups)) {
                            foreach ($allGroups as $val) {
                                ...
                                <div class="col-lg-3 page-card mb-4">
                                    <a href="group/<?= $val['slug'] . ".php"; ?>" class="page-card-header">
                                        <img class="page-card-img mb-4" src="<?= $val['group_picture']; ?>" alt="page-img">
                                        <br/>
                            ...
                            echo "You've not created any group yet.";
                        }
                        ?>
